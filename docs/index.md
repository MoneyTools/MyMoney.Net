...
**MyMoney**  is a rich client [.NET 10.0 ClickOnce application](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) for managing your personal finances.  See [Demo Video](https://youtu.be/u6BVF2x9FBA).
